...
$size_11_original_price = $_POST['size_11_original_price'] ?? '';
$size_12_original_price = $_POST['size_12_original_price'] ?? '';
$size_13_original_price = $_POST['size_13_original_price'] ?? '';
$size_14_original_price = $_POST['size_14_original_price'] ?? '';
$size_15_original_price = $_POST['size_15_original_price'] ?? '';
...
$size_11_price = $_POST['size_11_price'] ?? '';
$size_12_price = $_POST['size_12_price'] ?? '';
$size_13_price = $_POST['size_13_price'] ?? '';
$size_14_price = $_POST['size_14_price'] ?? '';
$size_15_price = $_POST['size_15_price'] ?? '';
...
if (isset($pdo)) {
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO main_shoes_original (product_id, product_seller_name, 
                                product_name, product_color, category, male_category, female_category,
                                ...
                                size_9_original_price, size_10_original_price, size_11_original_price, size_12_original_price, 
                                size_13_original_price, size_14_original_price, size_15_original_price,
                                size_1_price, size_2_price, size_3_price, size_4_price, size_5_price, size_6_price,
                                size_7_price, size_8_price, size_9_price, size_10_price, size_11_price, size_12_price,
                                size_13_price, size_14_price, size_15_price,
        ...
        $stmt->execute([
            ...
            $size_11_original_price,
            $size_12_original_price,
            $size_13_original_price,
            $size_14_original_price,
            $size_15_original_price,
            $size_1_price,
            $size_2_price,
            $size_3_price,
            $size_4_price,
