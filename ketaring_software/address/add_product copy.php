...
<body class="g-sidenav-show  bg-gray-200">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="multisteps-form__form" method="POST" action="add_product_process.php" enctype="multipart/form-data">
                        ...
                        <div class="multisteps-form__content">
                          <div class="row mt-3">
                            ...
                            <div class="col-12 col-sm-3 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic text-center">
                                <select name="category" id="category" class="multisteps-form__input form-control text-center" onchange="showCategoryDropdown()" required>
                                  <option value="">Select Category</option>
                                  <option value="जेन्टस">जेन्टस</option>
                                  <option value="लेडीज">लेडीज</option>
                                  <option value="लहान मुलगा">लहान मुलगा</option>
                                  <option value="लहान मुलगी">लहान मुलगी</option>
                            ...
                            <div class="col-6 col-sm-6" id="male-dropdown" style="display: none;">
                              <div class="input-group input-group-dynamic">
                                <select name="male_category" class="multisteps-form__input form-control text-center">
                                  <option value="">Select जेन्टस Product Category</option>
                                  <option value="शुज">शुज</option>
                                  <option value="चप्पल">चप्पल</option>
                                  <option value="फ्लिप फ्लॉप">फ्लिप फ्लॉप</option>
                                  <option value="क्रोक्स">क्रोक्स</option>
                                  <option value="स्लिप्पेर">स्लिप्पेर</option>
                                  <option value="लोफर">लोफर</option>
                                  <option value="सॅन्डल">सॅन्डल</option>
                                  <option value="इतर">इतर</option>
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-6" id="female-dropdown" style="display: none;">
                              <div class="input-group input-group-dynamic">
                                <select name="female_category" class="multisteps-form__input form-control text-center">
                                  <option value="">Select लेडीज Product Category</option>
                                  <option value="शुज">शुज</option>
                                  <option value="चप्पल">चप्पल</option>
                                  <option value="फॅन्सी चप्पल">फॅन्सी चप्पल</option>
                                  <option value="फ्लिप फ्लॉप">फ्लिप फ्लॉप</option>
                                  <option value="क्रोक्स">क्रोक्स</option>
                                  <option value="स्लिप्पेर">स्लिप्पेर</option>
                                  <option value="लोफर">लोफर</option>
                            ...
                            <div class="col-6 col-sm-6" id="child-male-dropdown" style="display: none;">
                              <div class="input-group input-group-dynamic">
                                <select name="child_male_category" class="multisteps-form__input form-control text-center">
                            ...
                            <div class="col-6 col-sm-6" id="child-female-dropdown" style="display: none;">
                              <div class="input-group input-group-dynamic">
                                <select name="child_female_category" class="multisteps-form__input form-control text-center">
                            ...
                            <div class="col-6 col-sm-6" id="other-dropdown" style="display: none;">
                              <div class="input-group input-group-dynamic">
                                <select name="other_category" class="multisteps-form__input form-control text-center">
                          ...
                          <div class="row mt-3">
                            ...
                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                ...
                                <input oninput="validateNumericInput(this)" name="11" id="input-11" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                ...
                                <input oninput="validateNumericInput(this)" name="12" id="input-12" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>size_10 size_10_price size_1_original_price
                          ...
                          <div class="row mt-3">
                            ...
                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                ...
                                <input oninput="validateNumericInput(this)" name="13" id="input-13" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>

                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                <label class="form-label">Size-14</label>
                                <input oninput="validateNumericInput(this)" name="14" id="input-14" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>

                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                <label class="form-label">Size-15</label>
                                <input oninput="validateNumericInput(this)" name="15" id="input-15" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>
                      ...
                      <div class="multisteps-form__panel border-radius-xl bg-white" data-animation="FadeIn">
                        <h5 class="font-weight-bold mb-0">Product Buying Price</h5>
                        <!--p class="mb-0 text-sm">Tell us where are you living</p-->
                        <div class="multisteps-form__content">
                          <div class="row mt-3">
                          ...
                          <div class="row mt-3">
                            ...
                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                <label class="form-label">Size-11-price</label>
                                <input oninput="validateNumericInput(this)" name="size_11_original_price" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                <label class="form-label">Size-12-price</label>
                                <input oninput="validateNumericInput(this)" name="size_12_original_price" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>
                          ...
                          <div class="row mt-3">
                            ...
                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                <label class="form-label">Size-13-price</label>
                                <input oninput="validateNumericInput(this)" name="size_13_original_price" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                <label class="form-label">Size-14-price</label>
                                <input oninput="validateNumericInput(this)" name="size_14_original_price" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                <label class="form-label">Size-15-price</label>
                                <input oninput="validateNumericInput(this)" name="size_15_original_price" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>


                          </div>
                          <h5 class="font-weight-bold mb-0" style="margin-top: 5%;">Product Box Price</h5>
                          <div class="row mt-3">
                          ...
                          <div class="row mt-3">
                            ...
                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                <label class="form-label">Size-11-price</label>
                                <input oninput="validateNumericInput(this)" name="size_11_price" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                <label class="form-label">Size-12-price</label>
                                <input oninput="validateNumericInput(this)" name="size_12_price" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>
                          ...
                          <div class="row mt-3">
                            ...
                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                <label class="form-label">Size-13-price</label>
                                <input oninput="validateNumericInput(this)" name="size_13_price" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                <label class="form-label">Size-14-price</label>
                                <input oninput="validateNumericInput(this)" name="size_14_price" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>
                            ...
                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                              <div class="input-group input-group-dynamic">
                                <label class="form-label">Size-15-price</label>
                                <input oninput="validateNumericInput(this)" name="size_15_price" class="multisteps-form__input form-control" type="text" required />
                              </div>
                            </div>
  ...
  <script>
    ...
    function updateQuantity() {
      ...
      const input11 = parseFloat(document.getElementById('input-11').value) || 0;
      const input12 = parseFloat(document.getElementById('input-12').value) || 0;
      const input13 = parseFloat(document.getElementById('input-13').value) || 0;
      const input14 = parseFloat(document.getElementById('input-14').value) || 0;
      const input15 = parseFloat(document.getElementById('input-15').value) || 0;

      // Calculate the sum
      const sum = input1 + input2 + input3 + input4 + input5 + input6 + input7 + input8 + input9 + input10 + input11 + input12 + input13 + input14 + input15;
    ...
    document.querySelectorAll('#input-1, #input-2, #input-3, #input-4, #input-5, #input-6, #input-7, #input-8, #input-9, #input-10, #input-11, #input-12, #input-13, #input-14, #input-15').forEach(input => {
