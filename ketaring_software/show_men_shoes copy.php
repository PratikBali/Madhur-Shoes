...
<body>
            ...
            <div class="right">
                <div id="product-details-container" style="position: relative;">
                    ...
                    <div class="left" style="position: absolute; top: 0%; left: 0%; color: white; padding: 10px; border-radius: 10px;">
                        ...
                        <a id="buy-btn" href="address/address.php?product_color=<?php echo $main_shoes->product_color; ?>&product_name=<?php echo $main_shoes->product_name; ?>">
                    ...
                    <div class="carousel-container" style="margin-top: -40%; margin-right: -25%;">
                        ...
                        <div class="carousel" id="carousel">
                            <?php
                                ...
                                $sql = "SELECT product_name, side FROM main_shoes WHERE product_name=?";
    ...
    <script>
        ...
        function updateBuyButton(productColor, productName) {
            const buyButton = document.getElementById('buy-btn');
            buyButton.href = `address/address.php?product_color=${productColor}&product_name=${productName}`;
        }
